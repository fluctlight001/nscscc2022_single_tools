...
// LINE2
  ...
  // //д��ַͨ���ź�
  //   .awid(awid),//д��ַID��������־һ��д�ź�
  //   .awaddr(awaddr),//д��ַ������һ��дͻ�������д��ַ
  //   .awlen(awlen),//ͻ�����ȣ�����ͻ������Ĵ���
  //   .awsize(awsize),//ͻ����С������ÿ��ͻ��������ֽ���
  //   .awburst(awburst),//ͻ������
  //   .awlock(awlock),//�������źţ����ṩ������ԭ����
  //   .awcache(awcache),//�ڴ����ͣ�����һ�δ���������ͨ��ϵͳ��
  //   .awprot(awprot),//�������ͣ�����һ�δ������Ȩ������ȫ�ȼ�
  //   .awvalid(awvalid),//��Ч�źţ�������ͨ���ĵ�ַ�����ź���Ч
  //   .awready(awready),//����"��"���Խ��յ�ַ�Ͷ�Ӧ�Ŀ����ź�

  // //д����ͨ���ź�
  //   .wid(wid),//һ��д�����ID tag
  //   .wdata(wdata),//д����
  //   .wstrb(wstrb),//д������Ч���ֽ��ߣ�����������8bits��������Ч��
  //   .wlast(wlast),//�����˴δ��������һ��ͻ������
  //   .wvalid(wvalid),//д��Ч�������˴�д��Ч
  //   .wready(wready),//�����ӻ����Խ���д����
  // //д��Ӧͨ���ź�
  //   .bid(bid),//д��ӦID tag
  //   .bresp(bresp),//д��Ӧ������д�����״̬ 00Ϊ��������Ȼ���Բ�����
  //   .bvalid(bvalid),//д��Ӧ��Ч
  //   .bready(bready),//���������ܹ�����д��Ӧ
  ...
  // //����ַͨ���ź�
  //   .arid(arid),//����ַID��������־һ��д�ź�
  //   .araddr(araddr),//����ַ������һ��дͻ������Ķ���ַ
  //   .arlen(arlen),//ͻ�����ȣ�����ͻ������Ĵ���
  //   .arsize(arsize),//ͻ����С������ÿ��ͻ��������ֽ���
  //   .arburst(arburst),//ͻ������
  //   .arlock(arlock),//�������źţ����ṩ������ԭ����
  //   .arcache(arcache),//�ڴ����ͣ�����һ�δ���������ͨ��ϵͳ��
  //   .arprot(arprot),//�������ͣ�����һ�δ������Ȩ������ȫ�ȼ�
  //   .arvalid(arvalid),//��Ч�źţ�������ͨ���ĵ�ַ�����ź���Ч
  //   .arready(arready),//����"��"���Խ��յ�ַ�Ͷ�Ӧ�Ŀ����ź�
  // //������ͨ���ź�
  //   .rid(rid),//��ID tag
  //   .rdata(rdata),//������
  //   .rresp(rresp),//����Ӧ�������������״̬
